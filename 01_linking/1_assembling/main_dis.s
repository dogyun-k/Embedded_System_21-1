...
0000000000001149 <main>:
    ...
    115a:	e8 20 00 00 00       	callq  117f <foo>
...
000000000000117f <foo>:
    117f:	f3 0f 1e fa          	endbr64 
    1183:	55                   	push   %rbp
    1184:	48 89 e5             	mov    %rsp,%rbp
    1187:	89 7d ec             	mov    %edi,-0x14(%rbp)
    118a:	8b 45 ec             	mov    -0x14(%rbp),%eax
    118d:	89 45 f8             	mov    %eax,-0x8(%rbp)
    1190:	8b 45 f8             	mov    -0x8(%rbp),%eax
    1193:	83 c0 02             	add    $0x2,%eax
